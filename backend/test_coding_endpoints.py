...
def test_coding_endpoints():
    ...
    print(f"   Status: {response.status_code}")
    if response.status_code == 200:
        print("   ✅ Code execution service healthy")
    else:
        print("   ❌ Code execution service unhealthy")
    ...
    try:
        ...
        print("   ✅ Judge0 service imported successfully")
        
        # Test if Judge0 is configured
        if hasattr(judge0_execution_service, 'headers'):
            print("   ✅ Judge0 service initialized")
        else:
            print("   ⚠️  Judge0 service not fully configured")
    except Exception as e:
        print(f"   ❌ Judge0 service error: {e}")
    ...
    try:
        ...
        print(f"   ✅ Local execution service: {languages}")
    except Exception as e:
        print(f"   ❌ Local execution service error: {e}")
    
    print("\n🎯 Coding Platform Test Complete!")
    print("\n📋 Summary:")
