...
const Leaderboard: React.FC<LeaderboardProps> = ({ assessmentId, onClose }) => {
  ...
  const getRankIcon = (rank: number) => {
    switch (rank) {
      ...
      default:
        return <span className="w-6 h-6 flex items-center justify-center text-purple-400 font-bold">{rank}</span>
    }
  }
    ...
    >
      ...
      >
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl font-bold">Assessment Leaderboard</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
              <div className="bg-elevated rounded-lg p-4 border border-base">
                <div className="flex items-center space-x-2 mb-2">
                  ...
                  <span className="text-muted-fg font-medium">Total Participants</span>
                </div>
              ...
              <div className="bg-elevated rounded-lg p-4 border border-base">
                <div className="flex items-center space-x-2 mb-2">
                  ...
                  <span className="text-muted-fg font-medium">Average Score</span>
                </div>
              ...
              <div className="bg-elevated rounded-lg p-4 border border-base">
                <div className="flex items-center space-x-2 mb-2">
                  ...
                  <span className="text-muted-fg font-medium">Top Performer</span>
                </div>
                <div className="text-lg font-bold text-purple-400">{leaderboard[0]?.student_name || "N/A"}</div>
              </div>
            </div>
                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        <h4 className="text-fg font-semibold">{entry.student_name}</h4>
