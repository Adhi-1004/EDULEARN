  ...
  return (
    <motion.nav
      ...
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
        scrolled ? "bg-card/95 border-b border-border shadow-md backdrop-blur-xl" : "bg-background/70 backdrop-blur-md"
      }`}
    >
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-4">
            <Link to="/" className="flex items-center space-x-3">
              <motion.div
                className="w-10 h-10 rounded-xl flex items-center justify-center text-lg font-bold bg-primary text-primary-foreground"
            ...
            <div className="px-4 pt-2 pb-4 space-y-2">
              ...
              {!user && (
                ...
                >
                  <Link
                    to="/signup"
                    className={`block px-4 py-3 rounded-xl text-base font-medium transition-all duration-200 text-center ${
                      mode === "professional"
                        ? colorScheme === "dark"
