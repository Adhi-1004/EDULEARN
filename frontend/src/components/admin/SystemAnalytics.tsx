      ...
      <div className="border-b border-gray-200 dark:border-gray-700">
        <nav className="-mb-px flex space-x-8">
          {[
            ...
            { id: 'teachers', label: 'Teacher Performance', icon: Award }
          ].map((tab) => (
            <button
              key={tab.id}
      ...
      {activeTab === 'overview' && metrics && (
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            >
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-semibold text-gray-900 dark:text-white">{metrics.total_users.toLocaleString()}</p>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-semibold text-gray-900 dark:text-white">{metrics.active_users_today.toLocaleString()}</p>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-semibold text-gray-900 dark:text-white">{metrics.total_assessments.toLocaleString()}</p>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="flex items-center">
                <div className={`p-2 rounded-lg ${getHealthBg(metrics.platform_health_score)}`}>
                  <Zap className={`h-6 w-6 ${getHealthColor(metrics.platform_health_score)}`} />
                </div>
                <div className="ml-4">
                  <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Platform Health</p>
                  <p className={`text-2xl font-semibold ${getHealthColor(metrics.platform_health_score)}`}>
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-sm font-medium text-gray-900 dark:text-white">
                    {metrics.user_engagement_rate.toFixed(1)}%
                  </span>
                </div>
                <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                  <div 
                    className="bg-blue-600 h-2 rounded-full transition-all duration-300"
                    style={{ width: `${Math.min(metrics.user_engagement_rate, 100)}%` }}
                  ></div>
                </div>
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-sm font-medium text-gray-900 dark:text-white">
                    {metrics.content_completion_rate.toFixed(1)}%
                  </span>
                </div>
                <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                  <div 
                    className="bg-green-600 h-2 rounded-full transition-all duration-300"
                    style={{ width: `${Math.min(metrics.content_completion_rate, 100)}%` }}
                  ></div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-sm font-medium text-gray-900 dark:text-white">
                    {metrics.total_teachers.toLocaleString()}
                  </span>
                </div>
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-sm font-medium text-gray-900 dark:text-white">
                    {metrics.total_batches.toLocaleString()}
                  </span>
                </div>
              </div>
            </div>
                ...
                <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                  {contentAnalytics.map((content) => (
                    <tr key={content.content_id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-white">
                        {content.average_score.toFixed(1)}%
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center">
                          <div className="w-16 bg-gray-200 dark:bg-gray-600 rounded-full h-2 mr-2">
                            <div 
                              className="bg-blue-600 h-2 rounded-full transition-all duration-300"
                              style={{ width: `${Math.min(content.popularity_score, 100)}%` }}
                            ></div>
                          </div>
                          <span className="text-sm text-gray-600 dark:text-gray-400">
                            {content.popularity_score.toFixed(1)}%
                          </span>
                        </div>
                      </td>
                    </tr>
                ...
                <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                  {teacherPerformance.map((teacher) => (
                    <tr key={teacher.teacher_id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-white">
                        {teacher.average_student_score.toFixed(1)}%
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center">
                          <div className="w-16 bg-gray-200 dark:bg-gray-600 rounded-full h-2 mr-2">
                            <div 
                              className="bg-green-600 h-2 rounded-full transition-all duration-300"
                              style={{ width: `${Math.min(teacher.student_satisfaction, 100)}%` }}
                            ></div>
                          </div>
                          <span className="text-sm text-gray-600 dark:text-gray-400">
                            {teacher.student_satisfaction.toFixed(1)}%
                          </span>
                        </div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center">
                          <div className="w-16 bg-gray-200 dark:bg-gray-600 rounded-full h-2 mr-2">
                            <div 
                              ...
                              style={{ width: `${Math.min(teacher.content_quality_score, 100)}%` }}
                            ></div>
                          </div>
                          <span className="text-sm text-gray-600 dark:text-gray-400">
                            {teacher.content_quality_score.toFixed(1)}%
                          </span>
                        </div>
                      </td>
                    </tr>
