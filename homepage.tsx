...
/**
 * Single-file colorful homepage with a new "sunset neon" palette:
 * - Replaces previous pink/green/cyan tones with rose/amber/violet/magenta accents
...
/* FancyButton: gradient border + glow variants, defined inline for single-file usage */
  ...
  return (
    <button
      ...
      className={[
        ...
        isSecondary && "bg-white text-rose-700 hover:bg-white/90",
        ...
        !isGhost &&
          "before:[background:linear-gradient(140deg,rgba(244,63,94,.85),rgba(245,158,11,.85),rgba(168,85,247,.85))_padding-box]",
        !isOutline &&
          !isGhost &&
          !isSecondary &&
          "bg-[radial-gradient(circle_at_30%_30%,rgba(244,63,94,.35),transparent_40%),radial-gradient(circle_at_70%_70%,rgba(245,158,11,.35),transparent_40%)]",
        !isOutline &&
          !isGhost &&
          !isSecondary &&
          "hover:shadow-[0_0_40px_rgba(244,63,94,.25),inset_0_0_20px_rgba(245,158,11,.15)]",
...
function AuthModal({
  ...
  return (
    <div role="dialog" aria-modal="true" className="fixed inset-0 z-[100] flex items-center justify-center">
      ...
      <div className="relative z-10 w-full max-w-md rounded-2xl border border-white/10 bg-[#1a1222] p-6 text-white shadow-2xl">
        <div className="mb-4">
          <h3 className="text-xl font-semibold">{mode === "login" ? "Sign in to EduLearn" : "Create your account"}</h3>
        ...
        <div className="space-y-4">
          <label className="block">
            <span className="mb-1 block text-sm text-white">Email</span>
            <input
              type="email"
              className="w-full rounded-lg border border-white/10 bg-white/5 px-3 py-2 text-white placeholder:text-white/40 outline-none focus:ring-2 focus:ring-rose-400/60"
          ...
          <label className="block">
            <span className="mb-1 block text-sm text-white">Password</span>
            <input
              type="password"
              className="w-full rounded-lg border border-white/10 bg-white/5 px-3 py-2 text-white placeholder:text-white/40 outline-none focus:ring-2 focus:ring-rose-400/60"
              placeholder="********"
...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen overflow-hidden bg-[radial-gradient(40rem_40rem_at_10%_10%,rgba(244,63,94,0.16),transparent_60%),radial-gradient(35rem_35rem_at_90%_15%,rgba(245,158,11,0.16),transparent_60%),radial-gradient(32rem_32rem_at_15%_85%,rgba(168,85,247,0.16),transparent_60%),radial-gradient(30rem_30rem_at_85%_85%,rgba(236,72,153,0.16),transparent_60%),linear-gradient(180deg,#0b0a12_0%,#140e19_45%,#1e1524_100%)]">
      {/* Soft aurora ring */}
      <div className="pointer-events-none absolute inset-0 z-0">
        <motion.div
          ...
          style={{
            background:
              "conic-gradient(from 30deg, rgba(244,63,94,.22), rgba(245,158,11,.22), rgba(168,85,247,.22), rgba(236,72,153,.22), rgba(244,63,94,.22))",
          }}
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            <motion.div whileHover={{ scale: 1.05 }} className="flex items-center space-x-2">
              <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-gradient-to-br from-rose-500 to-amber-500">
                <GraduationCap className="h-5 w-5 text-white" />
              </div>
              <span className="bg-gradient-to-r from-rose-300 via-amber-300 to-fuchsia-300 bg-clip-text text-xl font-bold text-transparent">
                EduLearn AI
              </span>
            </motion.div>
      ...
      <section className="relative flex min-h-screen items-center justify-center overflow-hidden">
        <motion.div
          className="absolute -left-20 top-1/4 h-24 w-[60rem] rotate-12 bg-gradient-to-r from-rose-300/20 via-white/10 to-amber-300/20"
          animate={{ opacity: [0.3, 0.6, 0.3], x: [-20, 0, -20] }}
          transition={{ duration: 10, repeat: Number.POSITIVE_INFINITY, ease: "easeInOut" }}
        />
        <motion.div
          className="absolute -right-24 top-2/3 h-24 w-[60rem] -rotate-12 bg-gradient-to-r from-fuchsia-300/20 via-white/10 to-violet-300/20"
          ...
          <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
            ...
            >
              <motion.div
                ...
                className="mb-6 inline-flex items-center rounded-full bg-gradient-to-r from-rose-200/20 to-amber-200/20 px-4 py-2 text-sm font-medium text-white/90 ring-1 ring-white/10"
              >
              ...
              >
                Transform Your{" "}
                <span className="bg-gradient-to-r from-rose-400 via-amber-300 to-fuchsia-300 bg-clip-text text-transparent">
                  Educational Journey
                </span>{" "}
                with AI
              </motion.h1>
                ...
                {[
                  ...
                  <motion.div key={index} whileHover={{ scale: 1.05 }} className="group text-center">
                    <div className="mb-2 flex items-center justify-center">
                      <div className="mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-br from-rose-500 to-amber-500 shadow">
            ...
            {/* Rotating feature card indicator */}
            <motion.div
              initial={{ opacity: 0, x: 50 }}
              animate={{ opacity: 1, x: 0 }}
            ...
            >
              <div className="h-full w-full rounded-2xl bg-gradient-to-br from-[#1f1524] to-[#1a101e] ring-1 ring-white/10" />
              <motion.div
                key={currentFeature}
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              <motion.div
                ...
                className="absolute -right-4 -top-4 flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-amber-400 to-rose-500 shadow-lg"
              >
              ...
              <motion.div
                ...
                className="absolute -bottom-4 -left-4 flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-br from-fuchsia-400 to-violet-500 shadow-lg"
              >
      ...
      <section ref={featuresRef} className="relative bg-gradient-to-br from-[#0e0a12] via-[#160f1c] to-[#221628] py-20">
        <div className="absolute inset-0 opacity-40">
          <motion.div
            className="absolute left-10 top-10 h-40 w-40 rounded-full bg-rose-500/20 blur-3xl"
            animate={{ x: [0, 20, -10, 0], y: [0, -10, 15, 0] }}
            transition={{ duration: 18, repeat: Number.POSITIVE_INFINITY, ease: "easeInOut" }}
          />
          <motion.div
            className="absolute right-10 bottom-10 h-48 w-48 rounded-full bg-amber-500/20 blur-3xl"
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            <motion.div variants={fadeInUp}>
              <span className="mb-4 inline-flex items-center rounded-full bg-rose-300/10 px-4 py-2 text-sm font-medium text-rose-200 ring-1 ring-rose-300/20">
              ...
              <motion.div key={i} variants={fadeInUp}>
                <div className="relative h-full overflow-hidden rounded-2xl border border-white/10 bg-white/5 p-6 shadow-2xl backdrop-blur transition-all duration-300 hover:shadow-[0_0_0_1px_rgba(255,255,255,0.1)]">
                  <div
                    ...
                    style={{
                      background: "radial-gradient(60rem 24rem at 0% 0%, rgba(244,63,94,0.08), transparent 50%)",
                    }}
                  />
      ...
      {/* Stats with NEW palette (replacing the image's teal/green gradient) */}
      <section
        ref={statsRef}
        className="relative overflow-hidden bg-gradient-to-r from-rose-600 via-amber-600 to-fuchsia-600 py-20 text-white"
      >
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            {[
              { value: "2M+", label: "Active Students", icon: Users, color: "from-rose-400 to-amber-400" },
              { value: "50K+", label: "Courses Available", icon: BookOpen, color: "from-fuchsia-400 to-violet-400" },
              { value: "99.2%", label: "Success Rate", icon: Trophy, color: "from-amber-400 to-rose-400" },
              { value: "24/7", label: "AI Support", icon: Brain, color: "from-pink-400 to-amber-400" },
            ].map((stat, index) => (
      ...
      {/* Testimonials */}
      <section ref={testimonialsRef} className="bg-[#0f0a14] py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <motion.div
            initial="hidden"
            whileInView="visible"
            ...
            {[
              ...
              <motion.div key={i} variants={fadeInUp}>
                <div className="relative h-full overflow-hidden rounded-2xl border border-white/10 bg-white/5 p-6 shadow-xl backdrop-blur transition-all duration-300 hover:shadow-[0_0_0_1px_rgba(255,255,255,0.1)]">
                  <div className="absolute right-0 top-0 -mr-10 -mt-10 h-20 w-20 rounded-full bg-gradient-to-br from-rose-500/10 to-amber-500/10 transition-transform group-hover:scale-150" />
                  <div className="relative z-10">
      ...
      {/* CTA */}
      <section className="relative overflow-hidden bg-gradient-to-r from-rose-600 via-amber-600 to-fuchsia-600 py-20 text-white">
        <div className="absolute inset-0">
      ...
      <footer className="relative overflow-hidden bg-[#0b0a12] py-16 text-white">
        <div className="absolute inset-0 bg-gradient-to-br from-[#0b0a12] via-rose-950/20 to-amber-950/20" />
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
