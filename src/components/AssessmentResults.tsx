    ...
    >
      ...
      >
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl font-bold text-purple-200">Assessment Results</h2>
          <button
            onClick={onClose}
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          <div className="bg-purple-800/30 rounded-lg p-4 border border-purple-500/30">
            <div className="flex items-center space-x-2 mb-2">
              ...
              <span className="text-purple-300 font-medium">Score</span>
            </div>
          ...
          <div className="bg-purple-800/30 rounded-lg p-4 border border-purple-500/30">
            <div className="flex items-center space-x-2 mb-2">
              ...
              <span className="text-purple-300 font-medium">Accuracy</span>
            </div>
            <div className={`text-2xl font-bold ${getGradeColor(result.percentage)}`}>
              {result.percentage.toFixed(1)}%
            </div>
          ...
          <div className="bg-purple-800/30 rounded-lg p-4 border border-purple-500/30">
            <div className="flex items-center space-x-2 mb-2">
              ...
              <span className="text-purple-300 font-medium">Time Taken</span>
            </div>
          ...
          <div className="bg-purple-800/30 rounded-lg p-4 border border-purple-500/30">
            <div className="flex items-center space-x-2 mb-2">
              ...
              <span className="text-purple-300 font-medium">Performance</span>
            </div>
            <div className={`text-2xl font-bold ${getGradeColor(result.percentage)}`}>
        ...
        <div className="space-y-4">
          <h3 className="text-lg font-semibold text-purple-200 mb-4">Question Review</h3>
